...
if __name__ == "__main__":
  ...
  Agent2=cfAct(2,[7,4],np.array([0,0,0]),False,1,0.8,0.6*np.array([[0,-1,0],[1,0,0]]))
  Agent4=cfAct(4,[2,5],np.array([-1,0,0]),False,1,1,0.6*np.array([[-1,0,0],[0,-1,0]]))
  Agent5=cfAct(5,[4],np.array([-1,1,0]),False,1,1.2,0.6*np.array([[0,1,0]]))
  Agent7=cfAct(7,[2],np.array([0,1,0]),False,1,1.2,0.6*np.array([[0,1,0]]))
  ...
  with open('consensus_circle_1.csv','w') as csvFile:
    ...
    while(True):
      if dt>0.01:
        ...
        Op_point_2=cal_Op_pos(DT,0.4,np.array([0,0])+0.6*np.array([-0.5,0.5]),r1,r1)
        Op_point_4=cal_Op_pos(DT,0.4,np.array([0,0])+0.6*np.array([0.5,0.5]),r2,r1)
        Op_point_5=cal_Op_pos(DT,0.4,np.array([0,0]+0.6*np.array([0.5,-0.5])),r3,r1)
        Op_point_7=cal_Op_pos(DT,0.4,np.array([0,0])+0.6*np.array([-0.5,-0.5]),r4,r1)
        c2=Agent2.get_pos()
        c4=Agent4.get_pos()
        c5=Agent5.get_pos()
        c7=Agent7.get_pos()
        writer.writerow([c2,c4,c5,c7,DT])
