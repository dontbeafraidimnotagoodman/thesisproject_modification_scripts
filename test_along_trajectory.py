...
## whats left
## change self.a self.b to make them stable at equilibrium point
## change update time to be faster
## change desire_pos-pos to pos- desire_pos
...
if __name__ == "__main__":
    ...
    virtual_target_pos=np.array([-0.5,0,0.5])## commented out when tests done
    m=0
